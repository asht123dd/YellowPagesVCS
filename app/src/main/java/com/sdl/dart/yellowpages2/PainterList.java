...
/**
 * Created by ashutosh on 27/9/17.
 */

public class PainterList extends DialogFragment {
    interface PainterListListener{
    ...
    PainterList.PainterListListener showPaintersListener;
    Context context;
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            showPaintersListener = (PainterList.PainterListListener) activity;
        } catch (ClassCastException e) {
            // The activity doesn't implement the interface, throw exception
            throw new ClassCastException(activity.toString()
                    + " must implement PainterListListener");
        }
    }
    //END
    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.painter, null));
